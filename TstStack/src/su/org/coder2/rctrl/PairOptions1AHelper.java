...
public class PairOptions1AHelper implements ISerializeHelper
{
	...
	ISerializeHelper _pairOptions0Ah = new PairOptions0AHelper ();
	...
	public Object createChannelObj(DataInputStream dis) throws IOException
	{
		...
		for (int i = 0; i < length; i++)
			retArray[i]=(PairOptions)_pairOptions0Ah.createChannelObj(dis);
		return retArray; 
	}
	...
	public void serialChannelObj(Object toArray, DataOutputStream dos) throws IOException
	{
		...
		for (int i=0;i<st.length;i++)
			_pairOptions0Ah.serialChannelObj(st[i], dos);
	}
