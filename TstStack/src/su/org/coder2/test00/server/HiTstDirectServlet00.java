 ...
 *
 */
public class HiTstDirectServlet00
		extends InitServlet
{
	protected String initChannelServlet(ServletConfig sc)
	{
		System.out.println("initChannelServlet: "+ HiTstDirectServlet00.class.getCanonicalName());
		MultiplObjectStorage.getInstance().registerifempty(new IHiTstImpl4Direct00());
		String name = IHiTstImpl4Direct00.class.getName();
