...
public abstract class SkelAuthenticate
		implements IAuthenticate ,IInvoker
{
	...
	private IAuthenticate impl=this;
...
//а было обработано по ошибке нижестоящим
		...
		switch (in.methodCode)
		{
			case 1 :
			{
				...
				String beginAuth0AretVal = impl.beginAuth(userName);
				_string0Ah.serialChannelObj(beginAuth0AretVal,dos);
				retMessage.bmessage = bos.toByteArray();
			}
			break;
			case 2 :
			{
				String guessPhrase = (String)_string0Ah.createChannelObj(dis);
				String endAuth0AretVal = impl.endAuth(guessPhrase);
				_string0Ah.serialChannelObj(endAuth0AretVal,dos);
				retMessage.bmessage = bos.toByteArray();
			}
			break;
			default:
