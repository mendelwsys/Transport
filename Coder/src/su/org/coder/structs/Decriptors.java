...
public class Decriptors
{
	...
	public final static String idlbasetypenames[]= {"longlong","double","long","string","short","boolean","octet"};
	public final static String reflectbasetypenames[]= {"long","double","int","String","short","boolean","byte"};
	public final static String reflectwraptypenames[]= {"Long","Double","Integer","String","Short","Boolean","Byte"};


	public final static String noobjects[]= {"long","double","int","short","boolean","byte"};

	public final static String createBase[]= {"SerialUtils.unserialong(dis)","SerialUtils.unserialdouble(dis)","SerialUtils.unserialint(dis,4)","(short)SerialUtils.unserialint(dis,2)","dis.readBoolean()","dis.readByte()"};
	public final static String serialBase[]= {"dos.write(SerialUtils.serializedint64(#A))","dos.write(SerialUtils.serializedbl64(#A))","dos.write(SerialUtils.serialint32(#A))","dos.write(SerialUtils.serialint16(#A))","dos.writeBoolean(#A)","dos.writeByte(#A)"};
