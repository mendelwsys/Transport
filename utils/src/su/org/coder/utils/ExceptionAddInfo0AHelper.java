 ...
 */
public class ExceptionAddInfo0AHelper
		implements ISerializeHelper
{
	...
	public Object createChannelObj(DataInputStream dis) throws IOException
	{
		...
		ExceptionAddInfo retVal = new ExceptionAddInfo();
		retVal.exIdentifier = new Byte(dis.readByte());
		return retVal;
	}
	...
	public void serialChannelObj(Object toArray, DataOutputStream dos) throws IOException
	{
		...
		dos.writeByte(((ExceptionAddInfo) toArray).exIdentifier.byteValue());
	}

	public String toPrintableString(Object toPrintable)
	{
		if (toPrintable instanceof Byte)
			return ((ExceptionAddInfo) toPrintable).exIdentifier.toString() + "\n";
