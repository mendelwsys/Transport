 ...
 */
public class Integer0AHelper implements ISerializeHelper
{
	...
	public Object createChannelObj(DataInputStream dis) throws IOException
	{
		...
		dis.readFully(buff);
		return new Integer(SerialUtils.unserialint32(buff));
				//new Integer(dis.readInt());
	}
	...
	public void serialChannelObj(Object toArray, DataOutputStream dos) throws IOException
	{
		...
		dos.writeByte(0);
		dos.write(SerialUtils.serialint32(((Integer) toArray).intValue()));
//		dos.writeInt(((Integer) toArray).intValue());
	}

	public String toPrintableString(Object toPrintable)
	{
		if (toPrintable instanceof Integer)
			return ((Integer) toPrintable).toString() + "\n";
